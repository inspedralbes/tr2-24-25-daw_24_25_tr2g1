...
<p>
        ...
        Penpot i Figma per dissenyar una experiència d’usuari intuïtiva.
        Taiga per a la gestió eficient del projecte.
        El nostre repositori GitHub, on desenvolupem i perfeccionem conjuntament la plataforma.</p>
        <h3><br>Per què triar AlumNet?<br></h3>
        <p>
        ...
        Uneix-te a nosaltres i forma part d’una xarxa en creixement que transforma la manera d’aprendre i créixer.
        Junts, construïm connexions que marquen la diferència.
        </p>
